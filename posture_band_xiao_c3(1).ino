...
void setup() {
  ...
  // Temporary close-range test setting for a board with no external antenna.
  // ESP_PWR_LVL_P9 is the maximum BLE power offered by this API (about +9 dBm).
  // This improves the chance of a link but cannot replace the U.FL antenna.
  ...
  Serial.println("PostureBand BLE ready (maximum TX power test mode)");
}
